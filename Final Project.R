...
data.frames <- list( "private_pi_data" = summary_year_private_year,
                     ...
                     "other_pi_data" = summary_year_other_year,
                     "updated_data" = data_updated, 
                      "military_table_data" = summary_year_military_plane, 
                      "other_table_data" = summary_year_other_plane, 
                      "private_table_data" = summary_year_private_plane)
